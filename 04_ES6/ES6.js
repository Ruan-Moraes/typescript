...
const turmaB = ['Fernando', ...turmaA, 'Miguel']; // Spread - Espalha os elementos de um array
console.log(turmaB);
...
console.log(`O nome do cientista é ${primeiroNome} e ele tem ${experiencia} anos de experiência`);
/* -------------------------------------------------------------------------- */
// Callback
